  ...
  return (
    <div>
      ...
      <section className="about-pear">
        ...
        <p id="about">
          Pear lets seniors connect with another random individual and talk
          about the things that interest them. Simply make an account then
          create or join a new conversation and you'll be chatting away in
          moments.
        </p>
      </section>
    </div>
